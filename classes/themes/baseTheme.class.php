...
class BaseTheme {
  ...
  function __construct($App = NULL) {
    ...
    $this->setAttributes('script-theme-main-js', $this->getThemeUrl('solstice') . 'public/javascript/main.min.js?var=1.9', 'src');
  }
...
EOHTML;
  ...
  public function getExtraHeaders() {
    ...
    $return = '<link rel="stylesheet" href="' . $this->getThemeUrl('solstice') . 'public/stylesheets/' . $styles_name . '.min.css?v0.108"/>' . PHP_EOL;
