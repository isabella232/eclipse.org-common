...
function solstice_variables(&$variables) {
	...
	$variables['session']['my_account_link'] = '<a href="https://dev.eclipse.org/site_login/?takemeback=' . (empty($_SERVER['HTTPS'])?'':'s') . ':' . $base_url . $_SERVER['REQUEST_URI'] . '"><i class="fa fa-sign-in fa-fw"></i> Sign in</a>';
