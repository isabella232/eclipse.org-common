...
function solstice_variables(&$variables) {
  ...
  $variables['session']['create_account_link'] = '<a href="https://dev.eclipse.org/site_login/?takemeback=http' . (empty($_SERVER['HTTPS'])?'':'s') . ':' . $base_url . $_SERVER['REQUEST_URI'] . '"><i class="fa fa-user fa-fw"></i> Create an Account</a>';
