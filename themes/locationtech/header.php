...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php print $Theme->getEclipseUrl();?><?php print $Theme->getThemeUrl(); ?>public/images/favicon.ico"/>
    <title><?php print $Theme->getPageTitle(); ?></title>
    <link rel="stylesheet" href="<?php print $Theme->getEclipseUrl();?><?php print $Theme->getThemeUrl('solstice'); ?>public/stylesheets/locationtech.min.css"/>
